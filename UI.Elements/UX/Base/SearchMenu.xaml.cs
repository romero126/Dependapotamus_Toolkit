...
namespace UI.Elements.UX
{
	...
	public partial class SearchMenu : UserControl
	{
		...
		public List<SearchMenu_Item> Items_List { get; set; }
		...
		public void RemoveItem(string guid) {
			foreach (SearchMenu_Item obj in Children.Children)
				if (obj.guid == guid)
					Children.Children.Remove(obj);
		}
		public void AddItem(string text)
		{
			SearchMenu_Item obj = new SearchMenu_Item();
			obj.Text = text;
		...
		public void AddItem(SearchMenu_Item obj)
		{
			Children.Children.Add(obj);
		}
